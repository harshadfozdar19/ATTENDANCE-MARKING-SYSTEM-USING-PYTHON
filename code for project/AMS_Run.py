...
window.iconbitmap('cu.ico')
window.geometry('1280x720')
window.configure(background='#1a0000')
...
def manually_fill():
    global sb
    sb = tk.Tk()
    sb.iconbitmap('cu.ico')
    sb.title("Enter subject name: ")
    sb.geometry('580x320')
    sb.configure(background='#1a0000')
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def err_screen1():
                ...
                errsc2.iconbitmap('cu.ico')
                errsc2.title('Warning!!')
                errsc2.configure(background='#ffffff')
            ...
            def create_csv():
                ...
                csv_name = '"C:/Users/harsh/OneDrive/Pictures/code for project/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'C:/Users/harsh/OneDrive/Pictures/code for project/Attendance/Manually Attendance/-------Check atttendance-------')
    ...
    fill_manual_attendance = tk.Button(sb, text="Fill Attendance", command=fill_attendance, fg="white", bg="#cc0000", width=20, height=2,
                                       activebackground="#b30000", font=('times', 15, ' bold '))
...
def err_screen():
    ...
    sc1.iconbitmap('cu.ico')
    sc1.title('Warning!!')
    sc1.configure(background='#1a0000')
    Label(sc1, text='Enrollment & Name required!!!', fg='white',
          bg='#cc0000', font=('times', 16)).pack()
    Button(sc1, text='OK', command=del_sc1, fg="black", bg="#cc0000", width=9,
           height=1, activebackground="#b30000", font=('times', 15, ' bold ')).place(x=90, y=50)
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/harsh/OneDrive/Pictures/code for project/Attendance/' + fileName
    ...
    windo = tk.Tk()
    windo.iconbitmap('cu.ico')
    windo.title("Enter subject name...")
    windo.geometry('580x320')
    windo.configure(background='#1a0000')
    Notifica = tk.Label(windo, text="Attendance filled Successfully", bg="#cc0000", fg="white", width=33,
                        height=2, font=('times', 15, 'bold'))

    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:/Users/harsh/OneDrive/Pictures/code for project/Attendance/-------Check atttendance-------"')
    ...
    fill_a = tk.Button(windo, text="Fill Attendance", fg="white", command=Fillattendances, bg="#cc0000", width=20, height=2,
                       activebackground="white", font=('times', 15, ' bold '))
...
def admin_panel():
    win = tk.Tk()
    win.iconbitmap('cu.ico')
    win.title("LogIn")
    win.geometry('880x520')
    win.configure(background='#1a0000')
    ...
    def log_in():
        ...
        if username == 'ADMIN':
            if password == '12345678':
                ...
                cs = 'C:/Users/harsh/OneDrive/Documents/code for project/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
    ...
    Nt = tk.Label(win, text="Attendance filled Successfully", bg="#cc0000", fg="white", width=40,
                  height=2, font=('times', 19, 'bold'))
    # Nt.place(x=120, y=350)
    ...
    Login = tk.Button(win, text="LogIn", fg="white", bg="#cc0000", width=20,
                      height=2,
                      activebackground="#b30000", command=log_in, font=('times', 15, ' bold '))
...
message = tk.Label(window, text="Face Recognition Based Attendance Management System", bg="#cc0000", fg="white", width=50,
...
AP = tk.Button(window, text="Check Registered students", command=admin_panel, fg="white",
               bg="#cc0000", width=19, height=1, activebackground="#b30000", font=('times', 15, ' bold '))
AP.place(x=990, y=410)

takeImg = tk.Button(window, text="Take Images", command=take_img, fg="white", bg="#cc0000",
                    width=20, height=3, activebackground="#b30000", font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Images", fg="white", command=trainimg, bg="#cc0000",
                     width=20, height=3, activebackground="#b30000", font=('times', 15, ' bold '))
trainImg.place(x=390, y=500)

FA = tk.Button(window, text="Automatic Attendance", fg="white", command=subjectchoose,
               bg="#cc0000", width=20, height=3, activebackground="#b30000", font=('times', 15, ' bold '))
